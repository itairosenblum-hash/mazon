      ...
      datasets:[
        {
          ...
          backgroundColor: stationTotals.map(s=>complianceColor(s.actual,s.required).bg),
          borderColor: stationTotals.map(s=>complianceColor(s.actual,s.required).border),
  ...
  try {
    ...
    if (reportType === 'monthly') {
      style += '\n' + [
        ...
        '.monthly-grid thead tr:first-child th { background:#e8c547; font-size:9px; white-space:normal; line-height:1.45; padding:3px 3px; }',
...
const MSG_TEMPLATES = {
  newuser: `שלום {שם} 👋\n\nברוך הבא למערכת מעקב קבלן זרוע הים!\n\n━━━━━━━━━━━━━━━━━━\n📋 מה המערכת?\n━━━━━━━━━━━━━━━━━━\nמערכת זו משמשת לדיווח יומי על נוכחות עובדים בתחנות הקייטרינג.\nכל מנהל תחנה נדרש להזין מדי יום את מספר העובדים הנוכחים לפי תפקיד.\n\n━━━━━━━━━━━━━━━━━━\n✅ מה מצופה ממך?\n━━━━━━━━━━━━━━━━━━\n• הזנת דוח נוכחות יומי עבור התחנה שלך\n• עדכון הנתונים בתחילת כל משמרת\n• במקרה של שינוי — עדכן את הדוח בהתאם\n\n━━━━━━━━━━━━━━━━━━\n🔐 פרטי כניסה\n━━━━━━━━━━━━━━━━━━\nשם משתמש: {username}\nסיסמה: {password}\n\n🌐 כניסה למערכת:\nhttps://itairosenblum-hash.github.io/mazon/\n\nלשאלות ועזרה — פנה למנהל המערכת.\nבהצלחה! 💪`,
